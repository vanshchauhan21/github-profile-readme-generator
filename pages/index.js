              ...
              <div className="border-2 overflow-x-hidden flex-wrap h-screen overflow-y-auto border-slate-800 rounded-md px-1 ">
                ...
                <div className="text-slate-300">
                  ...
                  <div className="flex flex-col md:flex-row  md:items-center md:justify-center gap-2">
                   ...
                   <p>Create pull request and Don&apos;t forget to <a className="text-blue-500 no-underline  font-bold" href="https://github.com/vanshchauhan21/github-profile-readme-generator">Fork</a> and <a className="text-blue-500 no-underline font-bold" href="https://github.com/vanshchauhan21/github-profile-readme-generator">Star</a> this repo.</p>
                  </div>
                </div>
              </div>
            ) : (
